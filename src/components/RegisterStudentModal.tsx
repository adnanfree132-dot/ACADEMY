                          ...
                          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
                            <button
                              ...
                              style={{
                                ...
                                borderRadius: 9999,
                                fontSize: 10.5,
                                fontWeight: initialFeeOverride === String(proRataSuggestion.halfMonthFee) ? 700 : 600,
                            ...
                            <button
                              ...
                              style={{
                                ...
                                borderRadius: 9999,
                                fontSize: 10.5,
                                fontWeight: initialFeeOverride === String(proRataSuggestion.exactDailyProRata) ? 700 : 600,
                            ...
                            <button
                              ...
                              style={{
                                ...
                                borderRadius: 9999,
                                fontSize: 10.5,
                                fontWeight: initialFeeOverride === '' ? 700 : 600,
